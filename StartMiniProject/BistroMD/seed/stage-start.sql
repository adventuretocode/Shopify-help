...
DROP TABLE IF EXISTS `stage_bistro_recharge_migration`;
CREATE TABLE `stage_bistro_recharge_migration` (
...
DROP TABLE IF EXISTS `stage_source_bistro_recharge_migration`;
CREATE TABLE `stage_source_bistro_recharge_migration` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `gender` ENUM("Male", "Female"),
  `customer_id` INT DEFAULT NULL,
  `external_product_name` varchar(100) DEFAULT NULL,
...
DROP TABLE IF EXISTS `stage_track__customer`;
CREATE TABLE `stage_track__customer` (
  `id` INT NOT NULL AUTO_INCREMENT,
